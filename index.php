...
<body>
	...
	<div id="bandeau-top" class="text-center pt-1 pb-1">
	  <div class="container">
			Découvrez notre sélection de produits en stock livrés chez vous en 10 jours
			<div id="bandeau-top-links">
				<a href="#"><img src="img/🇫🇷 FR.png" width="13" height="13" alt=""/> FR</a>
				<a href="#">Français</a>
		  </div>
		</div>
	</div>
	...
	<nav id="main-nav">
		...
		<div class="container">
			...
			<div class="top-line mt-1 mt-lg-3 mb-3">
				...
				<div class="div-products d-none d-sm-inline d-lg-none"><a href="#">Produits</a></div>
				...
				<div class="div-account"><a class="ico-account ms-lg-4 me-lg-3" href="#"></a></div>
	...
	<header>
		...
		<div class="container">
			<nav class="breadcrumb breadcrumb-datalayer">
				<ol itemscope="" itemtype="http://schema.org/BreadcrumbList"> <img width="16px" loading="lazy" class="list_picto" src="https://cdn1.bobochicparis.com/themes/bobochic/img/icon/grey/home.svg" alt="Dimensions">
					<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem" data-category="Accueil" data-position="1"> 
			...
			<div class="text-center">
				<h1>Code promo Bobochic</h1>
				<h2>découvrez tous les codes promo actifs sur le site Bobochic</h2>
...
?>
		...
		<div class="row mb-5">
			...
			<div class="col-12">
				...
				<div class="grey-block d-md-flex align-content-center">
					<div>Vous pouvez également bénéficier d’une remise grâce à notre programme de parrainage. Toutes les infos sont sur la page parrainage.</div>
				
					<div class="align-self-center  ms-md-5 mt-3 mt-md-0"><a class="btn" href="#">Page parrainage</a></div>
				</div>
	...
	<footer>
		...
		<div class="container pt-4 pb-4 pt-lg-5 pb-lg-5">
			...
			<div class="row">
			  ...
			  <div class="col-12 col-md-6 col-lg-4 order-md-2 order-lg-1 newsletter">
				
					<div class="me-md-4 ms-lg-0">
					
						<span class="titre">NEWSLETTER</span><p><strong>Restez au courant des dernières nouveautés</strong></p>
					
						<form action="//bobochicparis.com/fr/" method="post"><div class="form-group"> <input class="search-input" type="email" placeholder="Votre adresse e-mail" value=""> <button class="send mt-2 mt-lg-4" type="submit" name="submitNewsletter">Envoyer <span></span></button> <input type="hidden" name="action" value="0"></div></form>
					
				  </div>
				
			  </div>
				<div class="col-12 col-lg-4  order-md-1 order-lg-2 text-center mt-4 mb-4  mt-md-2 mb-md-4  mt-lg-0 mb-lg-0">
					<div class="social">
						
						<div class="row d-flex">
							<div class="col-4 d-md-none d-lg-block col-lg-12 text-end text-md-start text-lg-center"><p class="mb-3 mb-md-0 mb-lg-2"><img class="img-fluid" src="img/logo.png" width="72" height="72" alt="Bobochic Paris"/></p></div>
							<div class="col-8 col-md-6 col-lg-12 text-start text-lg-center align-self-center">
								
								<div class="float-start me-3 d-none d-md-block d-lg-none"><img class="img-fluid" src="img/logo.png" width="72" height="72" alt="Bobochic Paris"/></div>
								
								<p class="fs-16 mt-md-2 mt-lg-0 mb-3"><strong>@bobochicparis</strong></p>
								<p class="mb-md-0 mb-lg-2">Suivez nous sur nos réseaux sociaux</p>
							</div>
							
							
							<div class="col-12 col-md-6 col-lg-12 all-items text-center text-md-end text-lg-center  align-self-center"> <a href="https://www.facebook.com/bobochicparis/" target="_blank"><img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/facebook.svg" alt="Logo Facebook"></a> <a href="https://www.instagram.com/bobochicparis/" target="_blank"><img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/instagram.svg" alt="Logo Instagram"></a> <a href="https://www.pinterest.fr/bobochicparis/" target="_blank"><img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/pinterest.svg" alt="Logo Pinterest"></a> <a href="https://www.tiktok.com/@bobochicparis?lang=fr" target="_blank"><img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/tiktok.svg" alt="Logo TikTok"></a> <a href="https://www.youtube.com/@BOBOCHICPARIS" target="_blank"><img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/youtube.svg" alt="Logo Youtube"></a></div>
			  	...
			  	<div class="col-12 col-md-6 col-lg-4 order-md-3 order-lg-3 contacter">
					<div class="ms-md-4 ms-lg-0">
						<span class="titre">CONTACT</span><p class="mb-0"><strong>Une équipe d’experts à votre service, disponible :</strong></p>
						  <ul class="ps-3 mb-2">
								<li><strong>du Lundi au Jeudi de 9h à 18h</strong></li>
								<li><strong>le Vendredi de 9h à 17h</strong></li>
							</ul>
						  <p class="fs-16"><strong>+33 1 76 36 12 35</strong></p>

						  <a class="btn" href="https://support.bobochicparis.com/hc/fr">Nous écrire <span></span></a>
					</div>
			  </div>
			...
			<div class="info">
				<div class="top row mt-5">
					<div class="col-12 col-lg-6 text-center text-lg-start">
						<div class="paiement"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/cb-picto.svg" alt="Pictogramme CB"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/visa-picto.svg" alt="Pictogramme VISA"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/master-picto.svg" alt="Pictogramme MasterCard"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/maestro-picto.svg" alt="Pictogramme Maestro"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/paypal-picto.svg" alt="Pictogramme Paypal"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/alma-picto.svg" alt="Pictogramme Alma"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/apple-picto.svg" alt="Pictogramme Apple"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/gpay-picto.svg" alt="Pictogramme Google Pay"> 
							<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/amex-picto.svg" alt="Pictogramme Amex">
						</div>
						<div class="desktop-part-bot">
							<div class="livraison"> 
								<p class="mb-1">Livraison dans les pays suivants :</p>
								<div class="all-items"> 
									<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/france.svg" alt="Drapeau français"> 
									<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/belgique.svg" alt="Drapeau belge"> 
									<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/lux.svg" alt="Drapeau luxembourgeois">
								</div>
							</div>
					...
					<div class="col-12 col-lg-6">	
						<div class="row">
							<div class="col-12 text-center text-lg-end mt-4 mt-lg-0">
								
								<a href="#" class="btn drop-down"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M10 1.75C5.44365 1.75 1.75 5.44365 1.75 10C1.75 14.5563 5.44365 18.25 10 18.25C14.5563 18.25 18.25 14.5563 18.25 10C18.25 5.44365 14.5563 1.75 10 1.75ZM0.25 10C0.25 4.61522 4.61522 0.25 10 0.25C15.3848 0.25 19.75 4.61522 19.75 10C19.75 15.3848 15.3848 19.75 10 19.75C4.61522 19.75 0.25 15.3848 0.25 10Z" fill="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.15077 3.91458C7.5428 5.43451 7.15 7.58571 7.15 10C7.15 12.4143 7.5428 14.5655 8.15077 16.0854C8.45559 16.8475 8.79979 17.4138 9.14363 17.7774C9.48598 18.1394 9.77562 18.25 10 18.25C10.2244 18.25 10.514 18.1394 10.8564 17.7774C11.2002 17.4138 11.5444 16.8475 11.8492 16.0854C12.4572 14.5655 12.85 12.4143 12.85 10C12.85 7.58571 12.4572 5.43451 11.8492 3.91458C11.5444 3.15254 11.2002 2.58618 10.8564 2.2226C10.514 1.8606 10.2244 1.75 10 1.75C9.77562 1.75 9.48598 1.8606 9.14363 2.2226C8.79979 2.58618 8.45559 3.15254 8.15077 3.91458ZM8.0538 1.19193C8.57285 0.643082 9.23027 0.25 10 0.25C10.7697 0.25 11.4271 0.643082 11.9462 1.19193C12.4638 1.7392 12.8953 2.49086 13.2419 3.3575C13.9369 5.09492 14.35 7.44373 14.35 10C14.35 12.5563 13.9369 14.9051 13.2419 16.6425C12.8953 17.5091 12.4638 18.2608 11.9462 18.8081C11.4271 19.3569 10.7697 19.75 10 19.75C9.23027 19.75 8.57285 19.3569 8.0538 18.8081C7.53625 18.2608 7.10471 17.5091 6.75806 16.6425C6.06309 14.9051 5.65 12.5563 5.65 10C5.65 7.44373 6.06309 5.09492 6.75806 3.3575C7.10471 2.49086 7.53625 1.7392 8.0538 1.19193Z" fill="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M18.1 8.05L1 8.05L1 6.55L18.1 6.55V8.05Z" fill="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M18.1 14.35L1.9 14.35L1.9 12.85L18.1 12.85V14.35Z" fill="white"/>
</svg> <img class="mb-1" src="img/🇫🇷 FR.png" width="16" height="16" alt="Français"> Français</a>
								<a href="#" class="btn drop-down ms-3">France</a>
							...
							<div class="col-12 text-end mt-4">
								...
								<div class="d-flex justify-content-between justify-content-lg-end">
									<div class="avis-verif">
										<div class="logo"> 
											<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/logo-av.svg" alt="Logo Avis vérifiés">
										</div>
										<div class="rate-avis text-start">
											<div class="nb-rate"> <span>4.5</span><span class="per-five">/5</span></div>
											<div class="rating stars">
												<div class="base"> 
													<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/star.svg" alt="star"> 
													<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/star.svg" alt="star"> 
													<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/star.svg" alt="star"> 
													<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/star.svg" alt="star"> 
													<img src="https://cdn1.bobochicparis.com/themes/bobochic/img/new-website/footer/star.svg" alt="star">
												</div>
												<div class="front" data-rate="4.0" style="width: 90%;">
													<div class="content"> 
									...
									<div class="produit-annee ms-4"><img src="img/POY-FR-2023 1.png" alt="Elu produit de l'année"></div>
				...
				<div class=" text-center text-lg-end mt-3 mt-lg-0">
					<p class="mb-lg-0"><strong>Copyright © 2024 Negomarkets Tous droits réservés.</strong></p>
					Magasin de canapés, meubles design, literies, décorations
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function copyCode(event) {
		...
		textArea.style.position = 'fixed';
		  ...
		  textArea.value = promo_code.innerHTML;
		...
		try {
			...
			console.log('Copying text command was ' + msg + " > " + promo_code.innerHTML);
		} catch (err) {
	...
	var boxes = document.querySelectorAll('.redirection .titre');
